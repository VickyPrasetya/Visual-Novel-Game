...
## тексту.
define gui.accent_color = '#ffce79'

define gui.title_text_outlines = [ (3, "#000000a0", 1, 1) ]

define gui.version_text_outlines = [ (3, "#000000a0", 1, 1) ]
...
define gui.interface_text_outlines = [ (3, "#000000a0", 1, 1) ]
...
define gui.title_text_ypos = -850

#define gui.title_text_xpos = -100

define gui.version_text_ypos = -850

#define gui.version_text_xpos = -100


## Головне та ігрове меню ######################################################

## Зображення, які використовуються для головного та ігрового меню.
define gui.main_menu_background = "Restaurant_B.png"
define gui.game_menu_background = "Restaurant_B.png"
...
define gui.dialogue_xpos = 502#402
