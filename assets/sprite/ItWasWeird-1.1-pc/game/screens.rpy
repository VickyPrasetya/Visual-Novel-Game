...
screen say(who, what):
    ...
    if not renpy.variant("small"):
        add SideImage() xalign 0.0 yalign 1.0 xpos -120
...
style say_thought is say_dialogue_narator
...
style window:
    ...
    background Image("gui/textbox_Cafechan.png", xalign=0.5, yalign=1.0)
...
screen about():
    ...
    use game_menu(_("Про гру"), scroll="viewport"):
        ...
        vbox:
            ...
            text _("Гра від {a=https://whitepaperchan.itch.io/}WhitePaperChan{/a}.\n\nГрафіка персонажів і фонів від {a=https://noranekogames.itch.io/}Noraneko Games{/a}.\n\nГрафічний інтерфейс від {a=https://lemmasoft.renai.us/forums/viewtopic.php?f=52&t=26762#p325231}Cafechan{/a}.\n\nМузика від {a=https://lolurio.itch.io/}lolurio{/a}.\n\nЗвуки від {a=https://pixabay.com/}Pixabay{/a}.\n\nСтворено за допомогою {a=https://www.renpy.org/}Ren'Py{/a} [renpy.version_only].\n\n[renpy.license!t]")
        ...
        vbox:
            ...
            hbox:
                ...
                vbox:
                    style_prefix "check"
                    label _("Пропустити")
                    textbutton _("Увесь текст") action Preference("skip", "toggle")
                ...
                vbox:
                    ...
                    textbutton _("Українська") action Language(None)
                    ...
                    if config.has_sound:
                        ...
                        hbox:
                            ...
                            if config.sample_sound:
                                textbutton _("Тест") action Play("sound", config.sample_sound) ypos 20
...
screen help():
    ...
    use game_menu(_("Довідка"), scroll="viewport"):
        ...
        vbox:
            ...
            hbox:
                text _("Якщо виникають проблеми з відображенням, як короткочасне миготіння, спробуйте змінити рендеринг через меню прискорення графіки (Shift+G).")
...
screen keyboard_help():
    ...
    hbox:
        label _("Tab")
        text _("Вмикає/вимикає пропуск діалогу.")
    ...
    hbox:
        label "Shift+G"
        text _("Відкриває меню прискорення графіки.")
